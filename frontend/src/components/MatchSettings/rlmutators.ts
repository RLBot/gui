export const mutators: { [x: string]: string[] } = {
  ...
  series_length: ["Unlimited", "Three Games", "Five Games", "Seven Games"],
  ...
  stale_ball: ["Default", "Thirty Seconds"],
  jump: [
    "Default",
    "Grounded",
    "Two",
  ...
  dodge_timer: ["Default", "Two Seconds", "Three Seconds", "Unlimited"],
  possession_score: ["Default", "One Second", "Two Seconds", "Three Seconds"],
  demolish_score: ["Default", "One", "Two", "Three"],
  normal_goal_score: ["Default", "Zero", "Two", "Three", "Five", "Ten"],
  aerial_goal_score: ["Default", "Zero", "Two", "Three", "Five", "Ten"],
  assist_goal_score: ["Default", "One", "Two", "Three"],
